...
public class Number : MonoBehaviour
{
    ...
    void Set(int value, float offsetX, bool topZero, int digit = 0)
    {
        ...
        for (int i = numbers.Count - 1; i >= 0; i--)
        {
            ...
            InstantiateNumber(i, false, offsetX);
        }

        // 数字の頭のマーク
        if(headMark != HeadMark.None)InstantiateNumber(numbers.Count, true, offsetX);
    }
    ...
    void InstantiateNumber(int i, bool isHead, float offsetX = 0)
    {
        //複製
        ...
        numberImage.localPosition = new Vector2(offsetX + -width * i, 0);
